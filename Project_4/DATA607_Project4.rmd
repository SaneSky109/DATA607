...
```{r}
spam_folder <- 'C:\\Users\\ericl\\OneDrive\\Documents\\CUNY MS in Data Science\\DATA-607\\R\\DATA607\\Project4_Data\\spam\\'
...
The Naive Bayes model was able to correctly classify email type 98.33% of the time. The model only incorrectly classified 4 ham emails as spam and 3 spam email as ham out of 300 emails. 
